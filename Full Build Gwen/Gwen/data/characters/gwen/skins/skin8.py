...
entries: map[hash,embed] = {
    "Characters/Gwen/Skins/Skin8" = SkinCharacterDataProperties {
        SkinClassification: u32 = 2
        ChampionSkinName: string = "GwenSkin08"
        SkinParent: i32 = 1
        ...
        SkinMeshProperties: embed = SkinMeshDataProperties {
            ...
            Texture: string = "ASSETS/Characters/Gwen/Skins/Skin08/Gwen_Skin08_TX_CM.dds"
            ...
            MaterialOverride: list[embed] = {
                SkinMeshDataProperties_MaterialOverride {
                    Texture: string = "ASSETS/Characters/Gwen/Skins/Skin08/Gwen_Skin08_Weapon_TX_CM.dds"
                ...
                SkinMeshDataProperties_MaterialOverride {
                    Texture: string = "ASSETS/Characters/Gwen/Skins/Skin08/Gwen_Skin08_Smears_TX_CM.dds"
                    Submesh: string = "Scissors_A_Smear"
                }
                SkinMeshDataProperties_MaterialOverride {
                    Material: link = 0x93ebec22
                    Submesh: string = "Skirt"
                }
                SkinMeshDataProperties_MaterialOverride {
                    Material: link = 0x3a60e746
                    Submesh: string = "Hair"
                }
                SkinMeshDataProperties_MaterialOverride {
                    Texture: string = "ASSETS/Characters/Gwen/Skins/Skin08/Gwen_Skin08_Doll_TX_CM.dds"
                    Submesh: string = "Doll"
                }
            }
        }
        ...
        mResourceResolver: link = "Characters/Gwen/Skins/Skin8/Resources"
    }
    0x3a60e746 = StaticMaterialDef {
        Name: string = "Characters/Gwen/Skins/Skin8/Materials/Outline_Iridescent_Add_Scroll_inst"
        SamplerValues: list2[embed] = {
            StaticMaterialShaderSamplerDef {
                SamplerName: string = "Diffuse_Texture"
                TextureName: string = "ASSETS/Characters/Gwen/Skins/Skin08/Gwen_Skin08_TX_CM.dds"
                AddressU: u32 = 1
                AddressV: u32 = 1
                AddressW: u32 = 1
            }
        ...
        ParamValues: list2[embed] = {
            StaticMaterialShaderParamDef {
                ...
                Value: vec4 = { 1, 0.862745106, 0.36470589, 1 }
            }
            StaticMaterialShaderParamDef {
                Name: string = "OutlineThickness"
                Value: vec4 = { 0.407499999, 0, 0, 0 }
            }
            StaticMaterialShaderParamDef {
                Name: string = "OutlineSoftness"
                Value: vec4 = { 0.392500013, 0, 0, 0 }
            }
            StaticMaterialShaderParamDef {
    ...
    0x93ebec22 = StaticMaterialDef {
        Name: string = "Characters/Gwen/Skins/Skin8/Materials/Outline_Iridescent_Add_Scroll_Skirt_inst"
        SamplerValues: list2[embed] = {
            StaticMaterialShaderSamplerDef {
                SamplerName: string = "Diffuse_Texture"
                TextureName: string = "ASSETS/Characters/Gwen/Skins/Skin08/Gwen_Skin08_TX_CM.dds"
            ...
            StaticMaterialShaderSamplerDef {
                SamplerName: string = "AdditiveScroll_Mask"
                TextureName: string = "ASSETS/Characters/Gwen/Skins/Skin08/Gwen_Skin8_TX_Mask.dds"
                AddressU: u32 = 1
                AddressV: u32 = 1
                AddressW: u32 = 1
            }
        ...
        ParamValues: list2[embed] = {
            StaticMaterialShaderParamDef {
                Name: string = "OutlineColor"
                Value: vec4 = { 1, 0.662745118, 0.192156866, 1 }
            }
            StaticMaterialShaderParamDef {
                Name: string = "OutlineThickness"
            ...
            StaticMaterialShaderParamDef {
                Name: string = "AdditiveScroll_ColorTint_R"
                Value: vec4 = { 0.298039228, 0, 0.0784313753, 0 }
            }
            StaticMaterialShaderParamDef {
                Name: string = "AdditiveTexScrollSpeed_R"
            }
    ...
    "Characters/Gwen/Skins/Skin8/Resources" = ResourceResolver {
