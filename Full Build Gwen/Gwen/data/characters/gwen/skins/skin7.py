...
entries: map[hash,embed] = {
    "Characters/Gwen/Skins/Skin7" = SkinCharacterDataProperties {
        SkinClassification: u32 = 2
        ChampionSkinName: string = "GwenSkin07"
        SkinParent: i32 = 1
        ...
        SkinMeshProperties: embed = SkinMeshDataProperties {
            ...
            Texture: string = "ASSETS/Characters/Gwen/Skins/Skin07/Gwen_Skin07_TX_CM.dds"
            ...
            MaterialOverride: list[embed] = {
                SkinMeshDataProperties_MaterialOverride {
                    Texture: string = "ASSETS/Characters/Gwen/Skins/Skin07/Gwen_Skin07_Weapon_TX_CM.dds"
                ...
                SkinMeshDataProperties_MaterialOverride {
                    Texture: string = "ASSETS/Characters/Gwen/Skins/Skin07/Gwen_Skin07_Smears_TX_CM.dds"
                    Submesh: string = "Scissors_A_Smear"
                }
                SkinMeshDataProperties_MaterialOverride {
                    Material: link = 0x2e5cce61
                    Submesh: string = "Skirt"
                }
                SkinMeshDataProperties_MaterialOverride {
                    Material: link = 0x56235e31
                    Submesh: string = "Hair"
                }
                SkinMeshDataProperties_MaterialOverride {
                    Texture: string = "ASSETS/Characters/Gwen/Skins/Skin07/Gwen_Skin07_Doll_TX_CM.dds"
                    Submesh: string = "Doll"
                }
            }
        }
        ...
        mResourceResolver: link = "Characters/Gwen/Skins/Skin7/Resources"
    }
    0x2e5cce61 = StaticMaterialDef {
        Name: string = "Characters/Gwen/Skins/Skin7/Materials/Outline_Iridescent_Add_Scroll_Skirt_inst"
        SamplerValues: list2[embed] = {
            StaticMaterialShaderSamplerDef {
                SamplerName: string = "Diffuse_Texture"
                TextureName: string = "ASSETS/Characters/Gwen/Skins/Skin07/Gwen_Skin07_TX_CM.dds"
                AddressU: u32 = 1
                AddressV: u32 = 1
                AddressW: u32 = 1
            }
            ...
            StaticMaterialShaderSamplerDef {
                ...
                TextureName: string = "ASSETS/Characters/Gwen/Skins/Skin07/Gwen_Skin7_TX_Mask.dds"
                AddressU: u32 = 1
                AddressV: u32 = 1
                AddressW: u32 = 1
            }
        ...
        ParamValues: list2[embed] = {
            StaticMaterialShaderParamDef {
                ...
                Value: vec4 = { 0.737254918, 0.941176474, 1, 1 }
            }
            StaticMaterialShaderParamDef {
    ...
    0x56235e31 = StaticMaterialDef {
        Name: string = "Characters/Gwen/Skins/Skin7/Materials/Outline_Iridescent_Add_Scroll_inst"
        SamplerValues: list2[embed] = {
            StaticMaterialShaderSamplerDef {
                SamplerName: string = "Diffuse_Texture"
                TextureName: string = "ASSETS/Characters/Gwen/Skins/Skin07/Gwen_Skin07_TX_CM.dds"
        ...
        ParamValues: list2[embed] = {
            StaticMaterialShaderParamDef {
                Name: string = "OutlineColor"
                Value: vec4 = { 0.882352948, 1, 0.894117653, 1 }
            }
            StaticMaterialShaderParamDef {
                Name: string = "OutlineThickness"
    ...
    "Characters/Gwen/Skins/Skin7/Resources" = ResourceResolver {
