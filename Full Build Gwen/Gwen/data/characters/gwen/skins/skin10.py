...
entries: map[hash,embed] = {
    "Characters/Gwen/Skins/Skin10" = SkinCharacterDataProperties {
        SkinClassification: u32 = 2
        ChampionSkinName: string = "GwenSkin10"
        SkinParent: i32 = 1
        ...
        SkinMeshProperties: embed = SkinMeshDataProperties {
            ...
            Texture: string = "ASSETS/Characters/Gwen/Skins/Skin10/Gwen_Skin10_TX_CM.dds"
            SelfIllumination: f32 = 0.699999988
            ReflectionFresnelColor: rgba = { 0, 0, 0, 255 }
            InitialSubmeshToHide: string = "Needle Body Hair Skirt"
            SubmeshRenderOrder: string = "Doll, Body, Needle Scissors, Scissors_A_Smear,Skirt,Hair"
            MaterialOverride: list[embed] = {
                SkinMeshDataProperties_MaterialOverride {
                    Texture: string = "ASSETS/Characters/Gwen/Skins/Skin10/Gwen_Skin10_Weapon_TX_CM.dds"
                ...
                SkinMeshDataProperties_MaterialOverride {
                    Texture: string = "ASSETS/Characters/Gwen/Skins/Skin10/Gwen_Skin10_Smears_TX_CM.dds"
                    Submesh: string = "Scissors_A_Smear"
                }
                SkinMeshDataProperties_MaterialOverride {
                    Material: link = 0x10975f25
                    Submesh: string = "Skirt"
                }
                SkinMeshDataProperties_MaterialOverride {
                    Material: link = 0xa84f23d5
                    Submesh: string = "Hair"
                }
                SkinMeshDataProperties_MaterialOverride {
                    Texture: string = "ASSETS/Characters/Gwen/Skins/Skin10/Gwen_Skin10_Doll_TX_CM.dds"
                    Submesh: string = "Doll"
                }
            }
        }
        ...
        mResourceResolver: link = "Characters/Gwen/Skins/Skin10/Resources"
    }
    0x10975f25 = StaticMaterialDef {
        Name: string = "Characters/Gwen/Skins/Skin10/Materials/Outline_Iridescent_Add_Scroll_Skirt_inst"
        SamplerValues: list2[embed] = {
            StaticMaterialShaderSamplerDef {
                SamplerName: string = "Diffuse_Texture"
                TextureName: string = "ASSETS/Characters/Gwen/Skins/Skin10/Gwen_Skin10_TX_CM.dds"
                AddressU: u32 = 1
                AddressV: u32 = 1
                AddressW: u32 = 1
            }
            StaticMaterialShaderSamplerDef {
                ...
                TextureName: string = "ASSETS/Shared/Materials/Gradient_Water_01.dds"
                AddressU: u32 = 1
                AddressV: u32 = 1
                AddressW: u32 = 1
            }
            ...
            StaticMaterialShaderSamplerDef {
                ...
                TextureName: string = "ASSETS/Characters/Gwen/Skins/Skin10/Gwen_Skin10_TX_Mask.dds"
                AddressU: u32 = 1
                AddressV: u32 = 1
                AddressW: u32 = 1
            }
        ...
        ParamValues: list2[embed] = {
            StaticMaterialShaderParamDef {
                ...
                Value: vec4 = { 1, 0.294117659, 0.447058827, 1 }
            }
            StaticMaterialShaderParamDef {
                Name: string = "OutlineThickness"
                Value: vec4 = { 0.257499993, 0, 0, 0 }
            }
            StaticMaterialShaderParamDef {
            ...
            StaticMaterialShaderParamDef {
                ...
                Value: vec4 = { 0.215686277, 0, 0.0862745121, 0 }
            }
            StaticMaterialShaderParamDef {
    ...
    0xa84f23d5 = StaticMaterialDef {
        Name: string = "Characters/Gwen/Skins/Skin10/Materials/Outline_Iridescent_Add_Scroll_inst"
        SamplerValues: list2[embed] = {
            StaticMaterialShaderSamplerDef {
                SamplerName: string = "Diffuse_Texture"
                TextureName: string = "ASSETS/Characters/Gwen/Skins/Skin10/Gwen_Skin10_TX_CM.dds"
        ...
        ParamValues: list2[embed] = {
            StaticMaterialShaderParamDef {
                Name: string = "OutlineColor"
                Value: vec4 = { 1, 0.0627451017, 0.627451003, 1 }
            }
            StaticMaterialShaderParamDef {
                Name: string = "OutlineThickness"
                Value: vec4 = { 0.42750001, 0, 0, 0 }
            }
            StaticMaterialShaderParamDef {
                Name: string = "OutlineSoftness"
            ...
            StaticMaterialShaderParamDef {
                Name: string = "IridescentControl"
                Value: vec4 = { 0.600000024, 1, 0.600000024, 0 }
            }
            StaticMaterialShaderParamDef {
                Name: string = "AdditiveStrength_R"
                Value: vec4 = { 1, 0, 0, 0 }
            ...
            StaticMaterialShaderParamDef {
                Name: string = "AdditiveScroll_ColorTint_R"
                Value: vec4 = { 0.0470588244, 0.00392156886, 0.352941185, 0 }
            }
            StaticMaterialShaderParamDef {
                Name: string = "AdditiveTexScrollSpeed_R"
            }
    ...
    "Characters/Gwen/Skins/Skin10/Resources" = ResourceResolver {
