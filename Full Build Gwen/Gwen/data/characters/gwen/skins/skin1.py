...
entries: map[hash,embed] = {
    "Characters/Gwen/Skins/Skin1" = SkinCharacterDataProperties {
        SkinClassification: u32 = 1
        ChampionSkinName: string = "GwenSkin01"
        ...
        SkinMeshProperties: embed = SkinMeshDataProperties {
            ...
            Texture: string = "ASSETS/Characters/Gwen/Skins/Skin01/Gwen_Skin1_TX_CM.dds"
            ...
            MaterialOverride: list[embed] = {
                SkinMeshDataProperties_MaterialOverride {
                    Texture: string = "ASSETS/Characters/Gwen/Skins/Skin01/Gwen_Skin1_Weapon_TX_CM.dds"
                ...
                SkinMeshDataProperties_MaterialOverride {
                    Texture: string = "ASSETS/Characters/Gwen/Skins/Skin01/Gwen_Skin01_Smears_TX_CM.dds"
                    Submesh: string = "Scissors_A_Smear"
                }
                SkinMeshDataProperties_MaterialOverride {
                    Material: link = 0x180f17d7
                    Submesh: string = "Skirt"
                }
                SkinMeshDataProperties_MaterialOverride {
                    Material: link = 0x2b532487
                    Submesh: string = "Hair"
                }
                SkinMeshDataProperties_MaterialOverride {
                    Texture: string = "ASSETS/Characters/Gwen/Skins/Skin01/Gwen_Skin1_Doll_TX_CM.dds"
                    Submesh: string = "Doll"
                }
            }
        }
        ...
        mResourceResolver: link = "Characters/Gwen/Skins/Skin1/Resources"
    }
    0x180f17d7 = StaticMaterialDef {
        Name: string = "Characters/Gwen/Skins/Skin1/Materials/Outline_Iridescent_Add_Scroll_Skirt_inst"
        SamplerValues: list2[embed] = {
            StaticMaterialShaderSamplerDef {
                SamplerName: string = "Diffuse_Texture"
                TextureName: string = "ASSETS/Characters/Gwen/Skins/Skin01/Gwen_Skin1_TX_CM.dds"
                AddressU: u32 = 1
                AddressV: u32 = 1
                AddressW: u32 = 1
            }
            StaticMaterialShaderSamplerDef {
                ...
                TextureName: string = "ASSETS/Characters/Gwen/Skins/Skin01/Gwen_Skin01_Iridescence_Orange.dds"
                AddressU: u32 = 1
                AddressV: u32 = 1
                AddressW: u32 = 1
            }
            ...
            StaticMaterialShaderSamplerDef {
                ...
                TextureName: string = "ASSETS/Characters/Gwen/Skins/Skin01/Gwen_Skin1_TX_Mask.dds"
                AddressU: u32 = 1
                AddressV: u32 = 1
                AddressW: u32 = 1
            }
        ...
        ParamValues: list2[embed] = {
            ...
            StaticMaterialShaderParamDef {
                ...
                Value: vec4 = { 2, 1.10000002, 0.600000024, 0 }
            }
            StaticMaterialShaderParamDef {
    ...
    0x2b532487 = StaticMaterialDef {
        Name: string = "Characters/Gwen/Skins/Skin1/Materials/Outline_Iridescent_Add_Scroll_inst"
        SamplerValues: list2[embed] = {
            StaticMaterialShaderSamplerDef {
                SamplerName: string = "Diffuse_Texture"
                TextureName: string = "ASSETS/Characters/Gwen/Skins/Skin01/Gwen_Skin1_TX_CM.dds"
            ...
            StaticMaterialShaderSamplerDef {
                SamplerName: string = "iridescentTex"
                TextureName: string = "ASSETS/Characters/Gwen/Skins/Skin01/Gwen_Skin01_Iridescence_Teal.dds"
                AddressU: u32 = 1
                AddressV: u32 = 1
                AddressW: u32 = 1
            }
        ...
        ParamValues: list2[embed] = {
            StaticMaterialShaderParamDef {
                Name: string = "OutlineColor"
                Value: vec4 = { 0.00392156886, 1, 0.752941191, 1 }
            }
            StaticMaterialShaderParamDef {
                Name: string = "OutlineThickness"
            ...
            StaticMaterialShaderParamDef {
                Name: string = "IridescentControl"
                Value: vec4 = { 4, 3.5, 0.400000006, 0 }
            }
            StaticMaterialShaderParamDef {
                Name: string = "AdditiveStrength_R"
                Value: vec4 = { 1, 0, 0, 0 }
    ...
    "Characters/Gwen/Skins/Skin1/Resources" = ResourceResolver {
