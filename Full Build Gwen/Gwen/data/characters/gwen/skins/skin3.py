...
entries: map[hash,embed] = {
    "Characters/Gwen/Skins/Skin3" = SkinCharacterDataProperties {
        SkinClassification: u32 = 2
        ChampionSkinName: string = "GwenSkin03"
        SkinParent: i32 = 1
        ...
        SkinMeshProperties: embed = SkinMeshDataProperties {
            ...
            Texture: string = "ASSETS/Characters/Gwen/Skins/Skin03/Gwen_Skin03_TX_CM.dds"
            ...
            MaterialOverride: list[embed] = {
                SkinMeshDataProperties_MaterialOverride {
                    Texture: string = "ASSETS/Characters/Gwen/Skins/Skin03/Gwen_Skin03_Weapon_TX_CM.dds"
                ...
                SkinMeshDataProperties_MaterialOverride {
                    Texture: string = "ASSETS/Characters/Gwen/Skins/Skin03/Gwen_Skin03_Smears_TX_CM.dds"
                    Submesh: string = "Scissors_A_Smear"
                }
                SkinMeshDataProperties_MaterialOverride {
                    Material: link = 0x3d43d4f5
                    Submesh: string = "Skirt"
                }
                SkinMeshDataProperties_MaterialOverride {
                    Material: link = 0xd3b62ae5
                    Submesh: string = "Hair"
                }
                SkinMeshDataProperties_MaterialOverride {
                    Texture: string = "ASSETS/Characters/Gwen/Skins/Skin03/Gwen_Skin03_Doll_TX_CM.dds"
                    Submesh: string = "Doll"
                }
            }
        }
        ...
        mResourceResolver: link = "Characters/Gwen/Skins/Skin3/Resources"
    }
    0x3d43d4f5 = StaticMaterialDef {
        Name: string = "Characters/Gwen/Skins/Skin3/Materials/Outline_Iridescent_Add_Scroll_Skirt_inst"
        SamplerValues: list2[embed] = {
            StaticMaterialShaderSamplerDef {
                SamplerName: string = "Diffuse_Texture"
                TextureName: string = "ASSETS/Characters/Gwen/Skins/Skin03/Gwen_Skin03_TX_CM.dds"
                AddressU: u32 = 1
                AddressV: u32 = 1
                AddressW: u32 = 1
            }
            StaticMaterialShaderSamplerDef {
                ...
                TextureName: string = "ASSETS/Shared/Materials/EDG_Rainbow.dds"
                AddressU: u32 = 1
                AddressV: u32 = 1
                AddressW: u32 = 1
            }
            ...
            StaticMaterialShaderSamplerDef {
                ...
                TextureName: string = "ASSETS/Characters/Gwen/Skins/Skin03/Gwen_Skin3_TX_Mask.dds"
                AddressU: u32 = 1
                AddressV: u32 = 1
                AddressW: u32 = 1
            }
        ...
        ParamValues: list2[embed] = {
            StaticMaterialShaderParamDef {
                ...
                Value: vec4 = { 0.870588243, 1, 0.290196091, 1 }
            }
            StaticMaterialShaderParamDef {
                Name: string = "OutlineThickness"
                Value: vec4 = { 0.319999993, 0, 0, 0 }
            }
            StaticMaterialShaderParamDef {
            ...
            StaticMaterialShaderParamDef {
                ...
                Value: vec4 = { 0.0156862754, 0.913725495, 0.0156862754, 0 }
            }
            StaticMaterialShaderParamDef {
    ...
    0xd3b62ae5 = StaticMaterialDef {
        Name: string = "Characters/Gwen/Skins/Skin3/Materials/Outline_Iridescent_Add_Scroll_inst"
        SamplerValues: list2[embed] = {
            StaticMaterialShaderSamplerDef {
                SamplerName: string = "Diffuse_Texture"
                TextureName: string = "ASSETS/Characters/Gwen/Skins/Skin03/Gwen_Skin03_TX_CM.dds"
            ...
            StaticMaterialShaderSamplerDef {
                SamplerName: string = "iridescentTex"
                TextureName: string = "ASSETS/Characters/Gwen/Skins/Skin02/Gwen_Skin01_Iridescence_Yellow.dds"
                AddressU: u32 = 1
                AddressV: u32 = 1
                AddressW: u32 = 1
            }
        ...
        ParamValues: list2[embed] = {
            StaticMaterialShaderParamDef {
                Name: string = "OutlineColor"
                Value: vec4 = { 0.0745098069, 0.376470596, 0.215686277, 1 }
            }
            StaticMaterialShaderParamDef {
                Name: string = "OutlineThickness"
            ...
            StaticMaterialShaderParamDef {
                Name: string = "AdditiveScroll_ColorTint_R"
                Value: vec4 = { 0.266666681, 0.482352942, 0.282352954, 0 }
            }
            StaticMaterialShaderParamDef {
                Name: string = "AdditiveTexScrollSpeed_R"
            }
    ...
    "Characters/Gwen/Skins/Skin3/Resources" = ResourceResolver {
