...
entries: map[hash,embed] = {
    "Characters/Gwen/Skins/Skin5" = SkinCharacterDataProperties {
        SkinClassification: u32 = 2
        ChampionSkinName: string = "GwenSkin05"
        SkinParent: i32 = 1
        ...
        SkinMeshProperties: embed = SkinMeshDataProperties {
            ...
            Texture: string = "ASSETS/Characters/Gwen/Skins/Skin05/Gwen_Skin05_TX_CM.dds"
            ...
            MaterialOverride: list[embed] = {
                SkinMeshDataProperties_MaterialOverride {
                    Texture: string = "ASSETS/Characters/Gwen/Skins/Skin05/Gwen_Skin05_Weapon_TX_CM.dds"
                ...
                SkinMeshDataProperties_MaterialOverride {
                    Texture: string = "ASSETS/Characters/Gwen/Skins/Skin05/Gwen_Skin05_Smears_TX_CM.dds"
                    Submesh: string = "Scissors_A_Smear"
                }
                SkinMeshDataProperties_MaterialOverride {
                    Material: link = 0xb2fdb6f3
                    Submesh: string = "Skirt"
                }
                SkinMeshDataProperties_MaterialOverride {
                    Material: link = 0xc29701f3
                    Submesh: string = "Hair"
                }
                SkinMeshDataProperties_MaterialOverride {
                    Texture: string = "ASSETS/Characters/Gwen/Skins/Skin05/Gwen_Skin05_Doll_TX_CM.dds"
                    Submesh: string = "Doll"
                }
            }
        }
        ...
        mResourceResolver: link = "Characters/Gwen/Skins/Skin5/Resources"
    }
    "Characters/Gwen/Skins/Skin5/Resources" = ResourceResolver {
    ...
    0xb2fdb6f3 = StaticMaterialDef {
        Name: string = "Characters/Gwen/Skins/Skin5/Materials/Outline_Iridescent_Add_Scroll_Skirt_inst"
        SamplerValues: list2[embed] = {
            StaticMaterialShaderSamplerDef {
                SamplerName: string = "Diffuse_Texture"
                TextureName: string = "ASSETS/Characters/Gwen/Skins/Skin05/Gwen_Skin05_TX_CM.dds"
                AddressU: u32 = 1
                AddressV: u32 = 1
                AddressW: u32 = 1
            }
            StaticMaterialShaderSamplerDef {
                ...
                TextureName: string = "ASSETS/Shared/Materials/Gradient_test_02.dds"
                AddressU: u32 = 1
                AddressV: u32 = 1
                AddressW: u32 = 1
            }
            ...
            StaticMaterialShaderSamplerDef {
                ...
                TextureName: string = "ASSETS/Characters/Gwen/Skins/Skin05/Gwen_Skin5_TX_Mask.dds"
                AddressU: u32 = 1
                AddressV: u32 = 1
                AddressW: u32 = 1
            }
        ...
        ParamValues: list2[embed] = {
            StaticMaterialShaderParamDef {
                ...
                Value: vec4 = { 0.501960814, 0.811764717, 1, 1 }
            }
            StaticMaterialShaderParamDef {
            ...
            StaticMaterialShaderParamDef {
                ...
                Value: vec4 = { 0, 0.145098045, 0.670588255, 0 }
            }
            StaticMaterialShaderParamDef {
    ...
    0xc29701f3 = StaticMaterialDef {
        Name: string = "Characters/Gwen/Skins/Skin5/Materials/Outline_Iridescent_Add_Scroll_inst"
        SamplerValues: list2[embed] = {
            StaticMaterialShaderSamplerDef {
                SamplerName: string = "Diffuse_Texture"
                TextureName: string = "ASSETS/Characters/Gwen/Skins/Skin05/Gwen_Skin05_TX_CM.dds"
            ...
            StaticMaterialShaderSamplerDef {
                SamplerName: string = "iridescentTex"
                TextureName: string = "ASSETS/Characters/Gwen/Skins/Skin04/Gwen_Skin01_Iridescence_Purple.dds"
                AddressU: u32 = 1
                AddressV: u32 = 1
                AddressW: u32 = 1
            }
        ...
        ParamValues: list2[embed] = {
            StaticMaterialShaderParamDef {
                Name: string = "OutlineColor"
                Value: vec4 = { 0, 0.984313726, 1, 1 }
            }
            StaticMaterialShaderParamDef {
                Name: string = "OutlineThickness"
                Value: vec4 = { 0.252499998, 0, 0, 0 }
            }
            StaticMaterialShaderParamDef {
                Name: string = "OutlineSoftness"
                Value: vec4 = { 0.504999995, 0, 0, 0 }
            }
            StaticMaterialShaderParamDef {
                Name: string = "AdditiveTexTile"
                Value: vec4 = { 1, 1, 0, 0 }
            ...
            StaticMaterialShaderParamDef {
                Name: string = "AdditiveScroll_ColorTint_R"
                Value: vec4 = { 0.149019614, 0, 0.113725491, 0 }
            }
            StaticMaterialShaderParamDef {
                Name: string = "AdditiveTexScrollSpeed_R"
            }
