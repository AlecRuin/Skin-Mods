...
entries: map[hash,embed] = {
    "Characters/Gwen/Skins/Skin4" = SkinCharacterDataProperties {
        SkinClassification: u32 = 2
        ChampionSkinName: string = "GwenSkin04"
        SkinParent: i32 = 1
        ...
        SkinMeshProperties: embed = SkinMeshDataProperties {
            ...
            Texture: string = "ASSETS/Characters/Gwen/Skins/Skin04/Gwen_Skin04_TX_CM.dds"
            ...
            MaterialOverride: list[embed] = {
                SkinMeshDataProperties_MaterialOverride {
                    Texture: string = "ASSETS/Characters/Gwen/Skins/Skin04/Gwen_Skin04_Weapon_TX_CM.dds"
                ...
                SkinMeshDataProperties_MaterialOverride {
                    Texture: string = "ASSETS/Characters/Gwen/Skins/Skin04/Gwen_Skin04_Smears_TX_CM.dds"
                    Submesh: string = "Scissors_A_Smear"
                }
                SkinMeshDataProperties_MaterialOverride {
                    Material: link = 0x7ac84df6
                    Submesh: string = "Skirt"
                }
                SkinMeshDataProperties_MaterialOverride {
                    Material: link = 0x3a18683a
                    Submesh: string = "Hair"
                }
                SkinMeshDataProperties_MaterialOverride {
                    Texture: string = "ASSETS/Characters/Gwen/Skins/Skin04/Gwen_Skin04_Doll_TX_CM.dds"
                    Submesh: string = "Doll"
                }
            }
        }
        ...
        mResourceResolver: link = "Characters/Gwen/Skins/Skin4/Resources"
    }
    0x3a18683a = StaticMaterialDef {
        Name: string = "Characters/Gwen/Skins/Skin4/Materials/Outline_Iridescent_Add_Scroll_inst"
        SamplerValues: list2[embed] = {
            StaticMaterialShaderSamplerDef {
                SamplerName: string = "Diffuse_Texture"
                TextureName: string = "ASSETS/Characters/Gwen/Skins/Skin04/Gwen_Skin04_TX_CM.dds"
                AddressU: u32 = 1
                AddressV: u32 = 1
                AddressW: u32 = 1
            }
            StaticMaterialShaderSamplerDef {
                ...
                TextureName: string = "ASSETS/Shared/Materials/SRX_TransitionGradient.dds"
                AddressU: u32 = 1
                AddressV: u32 = 1
                AddressW: u32 = 1
            }
        ...
        ParamValues: list2[embed] = {
            StaticMaterialShaderParamDef {
                ...
                Value: vec4 = { 1, 0.690196097, 0.811764717, 1 }
            }
            StaticMaterialShaderParamDef {
            ...
            StaticMaterialShaderParamDef {
                ...
                Value: vec4 = { 0, 0.0117647061, 0.827450991, 0 }
            }
            StaticMaterialShaderParamDef {
    ...
    0x7ac84df6 = StaticMaterialDef {
        Name: string = "Characters/Gwen/Skins/Skin4/Materials/Outline_Iridescent_Add_Scroll_Skirt_inst"
        SamplerValues: list2[embed] = {
            StaticMaterialShaderSamplerDef {
                SamplerName: string = "Diffuse_Texture"
                TextureName: string = "ASSETS/Characters/Gwen/Skins/Skin04/Gwen_Skin04_TX_CM.dds"
            ...
            StaticMaterialShaderSamplerDef {
                SamplerName: string = "AdditiveScroll_Mask"
                TextureName: string = "ASSETS/Characters/Gwen/Skins/Skin04/Gwen_Skin4_TX_Mask.dds"
                AddressU: u32 = 1
                AddressV: u32 = 1
                AddressW: u32 = 1
            }
        ...
        ParamValues: list2[embed] = {
            StaticMaterialShaderParamDef {
                Name: string = "OutlineColor"
                Value: vec4 = { 1, 0.615686297, 0.984313726, 1 }
            }
            StaticMaterialShaderParamDef {
                Name: string = "OutlineThickness"
    ...
    "Characters/Gwen/Skins/Skin4/Resources" = ResourceResolver {
